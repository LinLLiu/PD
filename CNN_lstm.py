...
from keras.layers import Dense, Dropout,Flatten,Conv2D,MaxPooling2D,LSTM,TimeDistributed,ConvLSTM2D,Embedding
...
model.add(TimeDistributed(Conv2D(filters=64,kernel_size=(3,3),padding='same',input_shape=(28,28,1),activation='relu')))
...
#batch_size 设为500时，验证准确率最高92左右。设为50时，最高92.56%
#model.compile(loss='binary_crossentropy',optimizer='adam', metrics=[f1])
#model.compile(loss='binary_crossentropy',optimizer='adam', metrics=['accuracy'])
model.compile(loss='binary_crossentropy',optimizer='adam', metrics=[auc])

train_history = model.fit(x=X_train4D_normalize,y=y_trainOneHot, validation_data=(X_test4D_normalize, y_testOneHot),
